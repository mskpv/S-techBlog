...
from .views import UserRegisterview , UserEditview, PasswordChangeView, ShowProfilePageView, EditProfilePageView, CreateProfilepageView, Passwdresetview, password_reset_request
